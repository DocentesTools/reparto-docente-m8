...
class MeetingSessionBase(SQLModel):
    ...
    status: MeetingSessionStatus = SQLField(
        default=MeetingSessionStatus.PREPARED,
        sa_column=Column(
            "status", enum_column_type(MeetingSessionStatus), nullable=False
        ),
    ...
    selection_mode: SelectionOrderMode = SQLField(
        default=SelectionOrderMode.NONE,
        sa_column=Column(
            "selection_mode", enum_column_type(SelectionOrderMode), nullable=False
        ),
